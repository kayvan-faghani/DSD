...
# ACDS 23.1 991 win32 2026.03.08.12:36:55
# ----------------------------------------
...
# ----------------------------------------
# If fp_mul_actual is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fp_mul_actual"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fp_mul_actual.vo"
}
